import{i as g,b as d,a as pe}from"./lit-element-B3y9oplH.js";import{n as l,o as $,r as u}from"./async-directive-ccEZ0_PR.js";import{M as k,a0 as le,R as c,C as me,c as v,r as V,a as f,A as H,e as fe,d as w,v as B,n as U,Y as we,G as F,E as K,O as A,l as M,S as E,y as z,Q as oe,T as be,U as ce,a1 as ge,a2 as ye}from"./react-KhSnktqr.js";import{P as D}from"./index-CuOCVLjB.js";import{S as ve}from"./SwapController-Bf7EJUmK.js";import"./wallet-o7fxzpvH.js";import"./index-byqkrLBW.js";import"./index.es-DbIYgNRe.js";import"./index-nibyPLVP.js";import"./browser-BvvN6nWp.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&me.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
...
`;var O=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const Re={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},Ae={lg:"lg",md:"md",sm:"sm"};let I=class extends g{constructor(){super(...arguments),this.imageSrc="",this.text="",this.size="lg",this.type="text-dropdown",this.disabled=!1}render(){return d`<button ?disabled=${this.disabled} data-size=${this.size} data-type=${this.type}>
    ...
    </wui-flex>`}};I.styles=[V,fe,Ie];O([l()],I.prototype,"imageSrc",void 0);O([l()],I.prototype,"text",void 0);O([l()],I.prototype,"size",void 0);O([l()],I.prototype,"type",void 0);O([l({type:Boolean})],I.prototype,"disabled",void 0);I=O([f("wui-select")],I);const Ee=v`
  wui-image {
...
`;var Q=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let _=class extends g{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return d`
    ...
    `}templateIcon(){const t={success:"success",error:"error",warning:"warning",info:"default"},i={success:"checkmark",error:"warning",warning:"warningCircle",info:"info"};return this.variant==="loading"?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon-box
      ...
      icon=${i[this.variant]}
    ></wui-icon-box>`}};_.styles=[V,Te];Q([l()],_.prototype,"message",void 0);Q([l()],_.prototype,"variant",void 0);_=Q([f("wui-snackbar")],_);const _e=pe`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
