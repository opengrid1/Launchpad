import{d as S,C as g,O as p,E as c,M as _,R as s,S as f,f as C,a as u,c as D,l as d,x as $,b as W}from"./react-KhSnktqr.js";import{W as b}from"./index-Cyx-uFkj.js";import{i as y,b as m,a as P}from"./lit-element-B3y9oplH.js";import{r as E}from"./async-directive-ccEZ0_PR.js";import{e as N,n as T}from"./browser-BvvN6nWp.js";import"./wallet-o7fxzpvH.js";import"./index-byqkrLBW.js";import"./index.es-DbIYgNRe.js";import"./index-nibyPLVP.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=S.state.activeChain,i=g.getConnections(n),o=(t=p.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=p.state.remoteFeatures)!=null&&r.emailCapture)return;if(p.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([u("w3m-email-verify-otp-view")],I);const U=D`
  wui-icon-box {
