import{i as k,b as u}from"./lit-element-B3y9oplH.js";import{n as x,o as v,r as b}from"./async-directive-ccEZ0_PR.js";import{c as $,r as N,e as R,a as C,d as c,S as w,n as h,T as f,U as A,g as S,W as I,R as T,f as O}from"./react-KhSnktqr.js";import"./wallet-o7fxzpvH.js";import"./index-byqkrLBW.js";import"./index.es-DbIYgNRe.js";import"./index-nibyPLVP.js";import"./browser-BvvN6nWp.js";const _=$`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var g=function(e,t,o,i){var s=arguments.length,r=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(s<3?n(r):s>3?n(t,o,r):n(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};let p=class extends k{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return u`
    ...
    </wui-flex>`}};p.styles=[N,R,_];g([x({type:Array})],p.prototype,"networkImages",void 0);g([x()],p.prototype,"text",void 0);p=g([C("wui-compatible-network")],p);const E=$`
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${v(f.state.themeVariables["--apkt-qr-color"]??f.state.themeVariables["--w3m-qr-color"])}
