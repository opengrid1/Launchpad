    ...
    loadTradingView()
      .then(() => {
        ...
        widget = new TV.widget({
          ...
          loading_screen: { backgroundColor: "#241a0e", foregroundColor: "#a3e635" },
          overrides: {
            "paneProperties.background": "#241a0e",
            "paneProperties.backgroundType": "solid",
            "paneProperties.vertGridProperties.color": "#332514",
            "paneProperties.horzGridProperties.color": "#332514",
            "scalesProperties.textColor": "#97846a",
            "scalesProperties.backgroundColor": "#241a0e",
            "mainSeriesProperties.candleStyle.upColor": "#8fd05a",
            "mainSeriesProperties.candleStyle.downColor": "#e0704f",
            "mainSeriesProperties.candleStyle.borderUpColor": "#8fd05a",
            "mainSeriesProperties.candleStyle.borderDownColor": "#e0704f",
            "mainSeriesProperties.candleStyle.wickUpColor": "#8fd05a",
            "mainSeriesProperties.candleStyle.wickDownColor": "#e0704f",
          },
          studies_overrides: {
            "volume.volume.color.0": "#e0704f",
            "volume.volume.color.1": "#8fd05a",
