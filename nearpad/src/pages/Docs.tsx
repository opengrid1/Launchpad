  ...
  return (
    <main>
      ...
      <div className="card"><div className="card-b docs-b">
        ...
        <p>Name, ticker, image, pair, tax rates and the four-way split are fixed at launch. There is no mint, no freeze, no blacklist and no pause on trading in the code. The platform can reassign a creator's fee wallet to a community lead on request, fix a picture or link, hide a coin from the list, pause new launches, add or switch off pairs for future launches, and move any share of a graduated coin's LP out of the coin to a wallet, which can then remove the liquidity on Rhea.</p>
        <h2>Costs</h2>
