...
import { ADDRESSES, DEPLOYED, FEES } from "../lib/env";
import { usd } from "../lib/format";
import { friendlyError, runTx, setToast } from "../lib/hooks";
...
export default function Launch() {
  ...
  const pair = { address: ADDRESSES.weth as Address, symbol: "USDC" };
  ...
  if (!DEPLOYED) return <main className="page"><section className="hero"><h1>Not live <em>yet</em>.</h1><p className="sub">The factory is not on Arc yet.</p></section></main>;

  return (
    <main className="page">
      <section className="hero" style={{ paddingTop: 10 }}>
        <h1>Launch a coin priced in <em>dollars</em>.</h1>
      </section>
        ...
        <aside className="preview">
          <div className="tile">
            <div className="tile-top">
              ...
              <span className="stamp eth"><i />USDC</span>
            </div>
            ...
            <dl className="kv">
              ...
              <dt>Priced in</dt><dd>USDC</dd>
              <dt>Pool fee</dt><dd>{FEES.taxPct}%</dd>
              <dt>Your share</dt><dd>{FEES.creatorPct}% of every fee, forever</dd>
              <dt>Platform</dt><dd>{FEES.platformPct}%</dd>
