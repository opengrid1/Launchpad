...
export default function Docs() {
  const steps: { icon: IconName; t: string; p: string }[] = [
    { icon: "launch", t: "Launch", p: "One transaction deploys a fixed 1B supply coin and puts all of it into a Uniswap V3 pool against USDC at about $3,000. Optional first buy in USDC. Liquidity is locked forever." },
