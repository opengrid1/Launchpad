...
import { BRAND, DEMO, env, FEED_HIDE_ALL, FEED_ONLY_PINNED, HIDDEN_TOKENS, PINNED_TOKENS } from "./lib/env";
    ...
    <>
      <header className="bar">
        <div className="bar-in">
          ...
          <div className="bar-r">
            <span className="bar-eth">Arc <b>{cfg ? `${FEED_HIDE_ALL ? 0 : FEED_ONLY_PINNED ? PINNED_TOKENS.length : Math.max(0, cfg.totalTokens - HIDDEN_TOKENS.size)} coins` : "—"}</b></span>
      ...
      {DEMO && <div className="demo">Design preview with sample coins. The factory is not wired yet, so nothing here can be bought or launched.</div>}
      <div className="wrap">
        <Routes>
