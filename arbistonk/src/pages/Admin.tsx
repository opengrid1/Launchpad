    ...
    <>
      ...
      <div className="panel" style={{ marginTop: 12, padding: 18 }}>
        ...
        <div className="row" style={{ flexWrap: "wrap" }}>
          <input className="inp" style={{ flex: 2, minWidth: 260 }} placeholder="ERC20 address on Arbitrum (18 decimals)" value={add.address} onChange={(e) => setAdd({ ...add, address: e.target.value })} />
