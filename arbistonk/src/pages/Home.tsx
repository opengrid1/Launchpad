    ...
    <main className="page">
      <section className="lead">
        <div className="say">
          ...
          <p>Launch a coin on Arbitrum with SpaceX, Circle, Apple or Robinhood stock{stocks > 4 ? ` (${stocks} tokenized stocks in all)` : ""} on the other side of the pool. Trade in plain ETH. Every swap pays {FEES.taxPct}%: half to the creator, {FEES.holderPct}% to holders, the rest to the platform.</p>
      ...
      {!DEPLOYED ? (
        <section className="sec"><div className="panel"><div className="empty">The factory is not on Arbitrum yet. Check back shortly.</div></div></section>
      ) : (
