  ...
  return (
    <main className="page">
      <section className="hero" style={{ paddingTop: 10 }}>
        ...
        <p className="sub">One factory on Arbitrum enforces all of it. A coin, a pool, a fee that pays three ways.</p>
      </section>
      <section className="sec">
        <div className="sec-h"><h2>The loop</h2><span className="caps">Uniswap V4 · Arbitrum One</span></div>
      ...
      <section className="sec">
        ...
        <div className="steps two">
          ...
          <div className="step"><div className="step-h"><Icon name="info" size={20} /><h3>Which stocks work</h3></div><p>Reality's tokenized stocks live on Arbitrum, but only some have a real pool today. Pairs marked "tradeable in ETH" have one, so buyers pay ETH. The rest can be paired, but buyers must already hold the stock.</p></div>
        </div>
      </section>
      <section className="sec">
