...
export default function Launch() {
  ...
  if (!DEPLOYED) return <main className="page"><section className="hero"><h1>Not live <em>yet</em>.</h1><p className="sub">The factory is not on Arbitrum yet.</p></section></main>;
