...
// Alicorn pair assets on Ethereum mainnet: ERC-20 tokens with a WETH pool,
// then the Ondo tokenized stocks ranked by real DEX liquidity. `route` is the
// ETH to pair path the router walks:
...
export interface Stock {
  /** "token" for plain ERC-20 pairs (UNI, LINK...), "stock" for tokenized stocks. */
  kind?: "token" | "stock";
  symbol: string;
  ticker: string;
  name: string;
...
/** Plain ERC-20 pairs: one V3 hop from WETH at `fee`. Prices come from the factory (Chainlink where set). */
export const TOKENS: Stock[] = [
  { kind: "token", symbol: "UNI", ticker: "UNI", name: "Uniswap", address: "0x1f9840a85d5af5bf1d1762f925bdaddc4201f984", usd: 8.71, liqUsd: 6_000_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "LINK", ticker: "LINK", name: "Chainlink", address: "0x514910771af9ca656af840dff83e8264ecf986ca", usd: 11.95, liqUsd: 4_800_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "AAVE", ticker: "AAVE", name: "Aave", address: "0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9", usd: 136.91, liqUsd: 1_800_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "MKR", ticker: "MKR", name: "Maker", address: "0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2", usd: 1553.49, liqUsd: 110_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "CRV", ticker: "CRV", name: "Curve DAO", address: "0xd533a949740bb3306d119cc777fa900ba034cd52", usd: 0.3318, liqUsd: 120_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "ENS", ticker: "ENS", name: "Ethereum Name Service", address: "0xc18360217d8f7ab5e7c516566761ea12ce7f9d72", usd: 6.26, liqUsd: 135_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "LDO", ticker: "LDO", name: "Lido DAO", address: "0x5a98fcbea516cf06857215779fd812ca3bef1b32", usd: 0.55, liqUsd: 200_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 500 } },
  { kind: "token", symbol: "PEPE", ticker: "PEPE", name: "Pepe", address: "0x6982508145454ce325ddbe47a25d4ec3d2311933", usd: 0.0000045, liqUsd: 110_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 3000 } },
  { kind: "token", symbol: "SHIB", ticker: "SHIB", name: "Shiba Inu", address: "0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce", usd: 0.0000065, liqUsd: 115_000, vol24Usd: 0, route: { kind: "v3", via: "WETH", fee: 10000 } },
];
...
/** Every pair asset the site knows: tokens first, then stocks. */
export const PAIRS: Stock[] = [...TOKENS, ...STOCKS.map((s) => ({ kind: "stock" as const, ...s }))];

export const stockByAddress = (addr?: string): Stock | undefined =>
  addr ? PAIRS.find((s) => s.address === addr.toLowerCase()) : undefined;
export const isTokenPair = (addr?: string) => stockByAddress(addr)?.kind === "token";
