...
/**
 * robinhood launchpad — Robinhood Chain (Hyperliquid, chainId 999), HyperSwap V3.
 *
...
const WHYPE = "0x0Bd7D308f8E1639FAb988df18A8011f41EAcAD73";
...
async function main() {
  ...
  writeFileSync(join(__dirname, "../deployments/robinhood-launchpad-v3.json"), JSON.stringify(out, null, 2));
