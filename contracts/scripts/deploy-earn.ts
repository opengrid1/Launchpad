...
async function main() {
  ...
  writeFileSync(join(__dirname, "../deployments/robinhood-earn.json"), JSON.stringify(out, null, 2));
  console.log("saved deployments/robinhood-earn.json  startBlock:", startBlock);
}
