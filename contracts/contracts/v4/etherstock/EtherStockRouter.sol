...
import {EtherStockFactory} from "./EtherStockFactory.sol";
...
/// @title EtherStockRouter
/// @notice One-tap trading for Etherstock coins in plain ETH, whatever the pair.
...
contract EtherStockRouter is IUnlockCallback, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IPoolManager public immutable poolManager;
    EtherStockFactory public immutable factory;
    ...
    constructor(IPoolManager pm, EtherStockFactory factory_, address weth_, ISwapRouter02 v3Router_) {
        poolManager = pm;
        factory = factory_;
        weth = weth_;
        v3Router = v3Router_;
