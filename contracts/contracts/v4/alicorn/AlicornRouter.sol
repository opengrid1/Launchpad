...
import {AlicornFactory} from "./AlicornFactory.sol";
...
/// @title AlicornRouter
/// @notice One-tap trading for alicorn coins in plain ETH, whatever the pair.
...
contract AlicornRouter is IUnlockCallback, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IPoolManager public immutable poolManager;
    AlicornFactory public immutable factory;
    ...
    constructor(IPoolManager pm, AlicornFactory factory_, address weth_, ISwapRouter02 v3Router_) {
        poolManager = pm;
        factory = factory_;
        weth = weth_;
        v3Router = v3Router_;
