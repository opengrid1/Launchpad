...
interface IAlicornCoin {
    function accrue(uint256 fee, uint256 extra) external;
}

/// @title AlicornHook
/// @notice Fee engine for the mainnet alicorn's Uniswap V4 pools. Every swap
...
contract AlicornHook is BaseHook, IUnlockCallback {
        ...
        returns (bytes4, int128)
    {
        ...
        IAlicornCoin(c.token).accrue(baseFee, fee - baseFee);
