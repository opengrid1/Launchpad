...
contract RhFinalFactory is Ownable, ReentrancyGuard, IUnlockCallback {
    ...
    constructor(address owner_, address protocolAdmin_, IPoolManager poolManager_, RhFinalHook hook_) Ownable(owner_) {
