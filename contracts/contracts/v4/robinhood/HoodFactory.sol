...
import {HoodHook} from "./HoodHook.sol";
...
contract HoodFactory is Ownable, ReentrancyGuard, IUnlockCallback {
    ...
    HoodHook public immutable hook;
    ...
    constructor(address owner_, address protocolAdmin_, IPoolManager poolManager_, HoodHook hook_, address weth_, address stateView_) Ownable(owner_) {
        weth = weth_;
